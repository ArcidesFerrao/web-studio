    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 75% 55% at 50% 42%, rgba(29,158,117,0.1) 0%, transparent 68%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      ...
      >
        ...
        >
          Sites que vendem.
          <br />
          <span style={{ color: "#1D9E75" }}>Código</span> que dura.
          <br />
          <span style={{ color: "rgba(238,234,255,0.22)" }}>
            Resultados
          </span>{" "}
          que ficam.
        </h1>
